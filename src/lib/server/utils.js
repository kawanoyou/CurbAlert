...
/**
 * プライバシー保護のため、正確な位置情報を±50mランダムにずらす
 * @param {number} lat - 正確な緯度
 * @param {number} lng - 正確な経度
 * @returns {{display_lat: number, display_lng: number}} ずらした位置
 */
export function obfuscateLocation(lat, lng) {
